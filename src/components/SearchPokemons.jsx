    ...
    <div className='flex mr-5 lg:self-end'>
        <form className='group'>
            <div className='relative'>
                <input className='border-2  group-hover:border-blue-500 border-[#223ba8] duration-200 pt-4 pb-4 pl-4 lg:pr-48 rounded-tl-2xl rounded-bl-2xl  outline-none' value={pokeName}  onChange={(event) => {changeName(event)}} placeholder='Search Pokémon'  ></input>
