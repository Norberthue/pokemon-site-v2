...
export default function PokemonList() {
  ...
  return (
    <div id='pokemonList' className='bg-[#060b28] text-white -mt-15 pb-20'>
        ...
        <div className='flex flex-col justify-between pt-20  gap-10 max-w-[1200px] m-auto border-b-1 border-[#24293f] pb-10 '>
          
          <div className='flex justify-center place-self-center lg:place-self-start gap-4 lg:ml-5'>
